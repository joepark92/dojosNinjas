...
<body>
	<div class="container">
		...
		<div class="main d-flex border border-dark border-2" style="flex-direction: column; padding: 10px;">
			<form:form action="/ninjas/new" method="post" modelAttribute="ninja"  class="table d-flex border border-dark border-2" style="flex-direction: column; padding: 10px;">
